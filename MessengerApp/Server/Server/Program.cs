...
namespace Server
{
    class Program
    {
        static List<string> message_list = new List<string>();
        ...
        static private void SendMessage(TcpClient client, string message)
        {
        ...
        public static void AcceptClient(TcpListener server)
        {
            ...
            SendMessage(client, JsonConvert.SerializeObject(message_list));
